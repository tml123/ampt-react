...
module.exports = {
  ...
  plugins: [
    ...
    new webpack.DefinePlugin({
            // use paths.servedPath to resolve the relative path of assets
            // necessary for spas so that we don't end up with /something/the-files
            // when we only want BASEURL/the-files
            CESIUM_BASE_URL: JSON.stringify(paths.servedPath)
        }),
